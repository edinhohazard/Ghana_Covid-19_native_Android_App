        ...
        when (viewItem) {
            ...
            is PerCountryItem -> {
                ...
                * But with reusable components*/
                when (viewItem.id) {
                    PerCountryItem.ID -> CountryGhanaActivity.startActivity(this)
                }
            }
            is TextItem -> {
